...
public class SkuSearchServiceImpl implements SkuSearchService {
    ...
    public void importSkuList(List<Sku> skuList) {
        ...
        for (Sku sku : skuList) {
            ...
            skuMap.put("specs", JSON.parseObject(sku.getSpecs(), Map.class));
    ...
    public Map search(Map<String, String> searchMap) {
        ...
        resultMap.put("brandList", brandMapper.findAllByCategoryName(categoryName));
...
//        List<Map> specList = specMapper.findAll();
